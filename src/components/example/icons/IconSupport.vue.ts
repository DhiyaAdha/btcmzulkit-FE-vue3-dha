...
{
const __VLS_0 = ({} as __VLS_IntrinsicElements)["svg"];
...
{
const __VLS_4 = ({} as __VLS_IntrinsicElements)["path"];
const __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, {});
({} as __VLS_IntrinsicElements).path;
const __VLS_6 = __VLS_5({ ...{ }, d: ("M10 3.22l-.61-.6a5.5 5.5 0 0 0-7.666.105 5.5 5.5 0 0 0-.114 7.665L10 18.78l8.39-8.4a5.5 5.5 0 0 0-.114-7.665 5.5 5.5 0 0 0-7.666-.105l-.61.61z"), }, ...__VLS_functionalComponentArgsRest(__VLS_5));
